// Envoltorio reutilizable para campos de formulario de Profesionales:
// label + control + mensaje de error, con el mismo estilo visual en
// todos los campos (mismo patrón que components/services/FormField.tsx,
// duplicado a propósito para que el módulo Profesionales no dependa de
// Servicios).
